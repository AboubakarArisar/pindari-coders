...
export default function SiteHeader() { return (<header className="site-header wrap">
  ...
  <nav aria-label="Main navigation"><Link href="/learn/">learn</Link><Link href="/lab/">the lab</Link><Link href="/trending/">trending</Link><Link href="/notes/">field notes</Link><Link href="/story/">our story</Link></nav>
