...
export default function SiteHeader() { return (<header className="site-header-shell"><div className="site-header wrap">
  ...
  <nav aria-label="Main navigation"><Link href="/learn/">learn</Link><Link href="/lab/">the lab</Link><Link href="/trending/">trending</Link><Link href="/resources/">resources</Link><Link className="nav-wall" href="/wall/"><span aria-hidden="true">✳</span> the wall</Link><Link className="nav-opportunities" href="/opportunities/"><span className="nav-live-dot" aria-hidden="true" /><span className="nav-opportunity-label">opportunities</span><span className="nav-opportunity-short">jobs</span></Link><Link href="/story/">our story</Link></nav>
