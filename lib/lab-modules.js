export const labDomains = [
  { slug: 'frontend', title: 'frontend & design', symbol: '</>', description: 'See how layout, type, and color change what people experience.', modules: ['Flexbox canvas', 'Typography studio', 'Color contrast'] },
  ...
  { slug: 'algorithms', title: 'algorithms', symbol: '[ ]', description: 'Slow things down. Follow each comparison and see how an answer takes shape.', modules: ['Bubble sort stepper', 'Binary search explorer'] },
