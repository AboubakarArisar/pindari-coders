...
export const metadata = {
  ...
  description: 'Coding experiments, practical learning roadmaps, and field notes by Abou Bakar Arisar.',
  authors: [{ name: 'Abou Bakar Arisar', url: 'https://aboubakarisar.tech/' }],
  icons: { icon: '/icon.svg' },
};
